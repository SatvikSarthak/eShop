...
// Retrieve products from the "Industrial Equipment" category from the database
$sql = "SELECT * FROM products WHERE Category = 'Industrial Equipment' AND stock_quantity > 0";
